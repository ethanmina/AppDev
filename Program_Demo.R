...
# The edit_student_attendance allows for the modification of a student's 
# attendance remark based on their assigned student ID. It iterates through the 
# student list and updates the attendance remark for the matching ID. If the 
# student is found, the attendance remark is updated, and the modified list is 
# returned. If the student is not found, the function prints an error message
# and returns the unchanged list.
...
executeFunction <- function(){
  ...
  while (TRUE) 
  {
    ...
    {
      # Edit Student Attendance choice prompts the student's ID and the 
      # appropriate status
      while (TRUE) 
      {
...
lint_script <- lint("Program_Demo.R")
print(lint_script)
